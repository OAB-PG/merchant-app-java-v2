...
function fnClickProcessMerchantHostVbVTransaction(){
	document.merchantHostedvbvTransaction.submit();
}
...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<form name="merchantHostedvbvTransaction" action="shopping/merchanthostedvbv/merchantHostedVbVBuyHttp.jsp" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" size="20"  id="mrchHstVbvamount" name="amount" value="0.100" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" size="20" id="mrchHstVbvudf1" name="udf1" value="Live Testing Kindly Ignore" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" size="20" id="mrchHstVbvudf2" name="udf2" value="Live Testing Kindly Ignore" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" size="20" id="mrchHstVbvudf3" name="udf3" value="Live Testing Kindly Ignore" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" size="20" id="mrchHstVbvudf4" name="udf4" value="Live Testing Kindly Ignore" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" size="20" id="mrchHstVbvudf5" name="udf5" value="Live Testing Kindly Ignore" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<button onclick="fnClickProcessMerchantHostVbVTransaction();" type="button" id="mrchHstVbvButtonClick" class="btn btn-default">Process</button>
					</div>
				</div>
